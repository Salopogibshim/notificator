...
values ('1','1','1','Мало средств на карте','Казна пустеет пополните ее',now(),'UNREAD'),
       ('2','1','2','Задолжность не погашена','Вам начислят завтра пени',2,now(),'UNREAD'),
       ('3','2','3','Новое предложение','МММ снова в моде',3,now(),'UNREAD'),
       ('5','2','4','Супер выгодный микрозайм','Возьмешь ты, а погасят твои дети',5,now(),'UNREAD');
