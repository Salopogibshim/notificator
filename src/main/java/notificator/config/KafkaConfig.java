...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> notificatorKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(notificatorConsumerFactory());
        return factory;
    }

    @Bean
    public ConsumerFactory<String, String> notificatorConsumerFactory() {
...
//        ));
    ...
    @Bean
    KafkaTemplate<String, String> notificatorKafkaTemplate() {
        KafkaTemplate<String, String> template = new KafkaTemplate<>(producerFactory());
        template.setConsumerFactory(notificatorConsumerFactory());
        return template;
    }
}
